...
const isEndOfPage = () => {
    const { scrollTop, clientHeight, scrollHeight } = document.documentElement; // document.documentElement Devuelve el Element que es el elemento raíz de document (por ejemplo, devuelve el elemento <html> en los documentos HTML).
    // clientHeight devuelve la altura de un elemento en píxeles, incluyendo el padding pero no las barras horizontales, el borde o el margen.
